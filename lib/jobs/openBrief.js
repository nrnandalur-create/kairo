...
export default async function handler(req, res) {
  ...
  try {
    ...
    // The handler reads req.headers['x-vercel-cron'] to authorize itself and
    // res.json to return; we mock both so the module can run in-process.
    const capturedRes = { status(s) { this._status = s; return this }, json(o) { this._body = o; return this }, _status: 200, _body: null }
    await smartSignalsMod.default({ headers: { 'x-vercel-cron': '1' }, query: {} }, capturedRes)
